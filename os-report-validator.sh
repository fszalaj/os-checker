...
sections=(
    ...
    "NTP Configuration|Invalid NTP server found|No NTP configuration file found|Neither chronyc nor ntpq commands are available|The following allowed NTP servers are missing|Unable to determine allowed NTP servers for network zone"
